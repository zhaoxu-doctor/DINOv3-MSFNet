...
def main(**kwargs):
    ...
    dst_dict = f"{src_dict}/logs/{MODEL_NAME}/{DATASET_NAME}_finetune_{date_time}"
    detection_log_dir = os.path.join(f"{src_dict}/finetune", f"{MODEL_NAME}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint-path',
                        type=str,
                        default=r"E:\segdino-main\segdino-main\segdata\csgo2\ckpt\DINOv3_csgo1_csgo_e50_mIoU80.22.pth",
